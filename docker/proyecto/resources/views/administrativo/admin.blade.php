...
<style>
    ...
    /* ===== STATUS PILLS (inherited if in admin.css, fallback here) ===== */
    .status-pill {
        display: inline-flex;
        align-items: center;
        gap: 4px;
        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="panel active" id="panel-gestion">
                    ...
                    <div class="kpi-row">
                        <div class="kpi"><span class="kpi-label">Facturado este año</span><span class="kpi-value">€41.2k</span><span class="kpi-delta up">↑ 12% vs 2025</span></div>
                        <div class="kpi"><span class="kpi-label">Gastos este año</span><span class="kpi-value">€38.4k</span><span class="kpi-delta warn">87% de ingresos</span></div>
                        <div class="kpi"><span class="kpi-label">Coches atendidos (año)</span><span class="kpi-value">296</span><span class="kpi-delta up">↑ 18 vs 2025</span></div>
                        <div class="kpi"><span class="kpi-label">Margen bruto</span><span class="kpi-value">€2.8k</span><span class="kpi-delta up">6.8%</span></div>
                    </div>
                    ...
                    <div class="grid-2">
                        <div class="card">
                            <div class="card-title" style="display:flex;align-items:center">
                                ...
                                <div class="chart-tabs">
                                    <button class="chart-tab active" onclick="switchChart('gastos','anual',this)">Anual</button>
                                    <button class="chart-tab" onclick="switchChart('gastos','mensual',this)">Mensual</button>
                                </div>
                            </div>
                            <div class="chart-section active" id="gastos-anual">
                                <svg id="chart-gastos-anual" viewBox="0 0 520 150" class="chart-svg"></svg>
                                <div class="chart-legend">
                                    <div class="chart-leg-item"><span class="chart-leg-dot" style="background:#2878f0"></span>Gastos mensuales 2026 (€)</div>
                                </div>
                            </div>
                            <div class="chart-section" id="gastos-mensual">
                                <svg id="chart-gastos-mensual" viewBox="0 0 280 150" class="chart-svg"></svg>
                                <div class="chart-legend">
                                    <div class="chart-leg-item"><span class="chart-leg-dot" style="background:#2878f0"></span>Gastos por semana · Mayo</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-last">
                            <div class="card-title" style="display:flex;align-items:center">
                                ...
                                Coches atendidos
                                <div class="chart-tabs">
                                    <button class="chart-tab active" onclick="switchChart('coches','anual',this)">Anual</button>
                                    <button class="chart-tab" onclick="switchChart('coches','mensual',this)">Mensual</button>
                                </div>
                            </div>
                            <div class="chart-section active" id="coches-anual">
                                <svg id="chart-coches-anual" viewBox="0 0 520 150" class="chart-svg"></svg>
                                <div class="chart-legend">
                                    <div class="chart-leg-item"><span class="chart-leg-dot" style="background:#22c55e"></span>Vehículos atendidos 2026</div>
                                </div>
                            </div>
                            <div class="chart-section" id="coches-mensual">
                                <svg id="chart-coches-mensual" viewBox="0 0 280 150" class="chart-svg"></svg>
                                <div class="chart-legend">
                                    <div class="chart-leg-item"><span class="chart-leg-dot" style="background:#22c55e"></span>Vehículos por semana · Mayo</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel" id="panel-usuarios">
                    <div class="kpi-row">
                        <div class="kpi"><span class="kpi-label">Usuarios totales</span><span class="kpi-value">6</span></div>
                        <div class="kpi"><span class="kpi-label">Clientes activos</span><span class="kpi-value">4</span><span class="kpi-delta up">↑ 1 este mes</span></div>
                        <div class="kpi"><span class="kpi-label">Mecánicos</span><span class="kpi-value">1</span></div>
                        <div class="kpi"><span class="kpi-label">Admins</span><span class="kpi-value">1</span></div>
                    </div>
                    <div class="card card-last">
                        <div class="card-title" style="display:flex;align-items:center">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="panel" id="panel-reparacion">
                    <div class="kpi-row">
                        <div class="kpi"><span class="kpi-label">Solicitudes pendientes</span><span class="kpi-value" id="kpi-sol-pend">3</span><span class="kpi-delta warn">Sin revisar</span></div>
                        <div class="kpi"><span class="kpi-label">Vehículos en taller</span><span class="kpi-value">6</span><span class="kpi-delta">Activos ahora</span></div>
                        <div class="kpi"><span class="kpi-label">En reparación</span><span class="kpi-value">2</span><span class="kpi-delta up">En proceso</span></div>
                        <div class="kpi"><span class="kpi-label">Pendiente pago</span><span class="kpi-value">1</span><span class="kpi-delta warn">Listo para cobrar</span></div>
                    </div>
                    ...
                    <div class="card card-last">
                        ...
                        <div class="veh-grid" id="vehiculosReparGrid"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="panel-vehiculos2">
                    <div class="kpi-row">
                        ...
                        <div class="kpi"><span class="kpi-label">Vendidos este mes</span><span class="kpi-value">3</span><span class="kpi-delta up">↑ 1 vs abril</span></div>
                    ...
                    <div class="card card-last">
                        ...
                        <div class="veh-grid" id="vehiculos2Grid"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="panel-piezas">
                    <div class="kpi-row">
                        <div class="kpi"><span class="kpi-label">Piezas en catálogo</span><span class="kpi-value">6</span></div>
                        <div class="kpi"><span class="kpi-label">Sin stock</span><span class="kpi-value" style="color:#f87171">1</span><span class="kpi-delta down">Requiere pedido</span></div>
                        <div class="kpi"><span class="kpi-label">Stock bajo (mín.)</span><span class="kpi-value" style="color:#fbbf24">2</span><span class="kpi-delta warn">Por debajo del mínimo</span></div>
                        <div class="kpi"><span class="kpi-label">Valor inventario</span><span class="kpi-value">€2.840</span><span class="kpi-delta">Precio compra</span></div>
                    </div>
                    <div class="card card-last">
                        <div class="card-title">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="pieza-grid" id="piezasGrid"></div>
                    </div>
                </div>
